...
function DashboardPage() {
  ...
  useEffect(() => {
    ...
    async function loadRelatedSafes() {
      console.log('[aave] connected address:', address);
      ...
      console.log('[aave] direct safes lookup:', direct);
